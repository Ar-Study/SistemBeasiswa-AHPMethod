                ...
                if ($query && mysqli_num_rows($query) > 0) {
                    ...
                    <table>
                        <tr>
                            ...
                            <td width="5px"> : </td>
                            <td> <?php echo htmlspecialchars($row['id_normalisasi']); ?> </td>
                        </tr>
                        <tr>
                            <td width="180px"><b> Id. Kriteria </b></td>
                            <td width="5px"> : </td>
                            <td> <?php echo "<a href='detail-kriteria.php?kode=" . htmlspecialchars($row['id_kriteria']) . "'>" . htmlspecialchars($row['id_kriteria']) . "</a>"; ?> </td>
                        </tr>
                        <tr>
                            <td width="180px"><b> Penghasilan Orang Tua </b></td>
                            <td width="5px"> : </td>
                            <td> <?php echo htmlspecialchars($row['n_penghasilan_ortu']); ?> </td>
                        </tr>
                        <tr>
                            <td width="180px"><b> Nilai IPK </b></td>
                            <td width="5px"> : </td>
                            <td> <?php echo htmlspecialchars($row['n_nilai_ipk']); ?> </td>
                        </tr>
                        <tr>
                            <td width="180px"><b> Semester </b></td>
                            <td width="5px"> : </td>
                            <td> <?php echo htmlspecialchars($row['n_semester']); ?> </td>
                        </tr>
                        <tr>
                            <td width="180px"><b> Tanggungan Orang Tua </b></td>
                            <td width="5px"> : </td>
                            <td> <?php echo htmlspecialchars($row['n_tanggungan_ortu']); ?> </td>
                        </tr>
                        <tr>
                            <td width="180px"><b> Saudara Kandung </b></td>
                            <td width="5px"> : </td>
                            <td> <?php echo htmlspecialchars($row['n_saudara_kandung']); ?> </td>
                        </tr>
                    </table>
                    <?php
                } else {
