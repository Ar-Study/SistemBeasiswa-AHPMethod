                ...
                if ($query) {
                    ...
                    if ($row) {
                        ...
                        <table>
                            ...
                            <tr>
                                <td width="180px"><b> Nama Lengkap </b></td>
                                <td width="5px"> : </td>
                                <td> <?php echo htmlspecialchars($row['nama_lengkap']); ?> </td>
                            </tr>
                            <tr>
                                <td width="180px"><b> Program Studi </b></td>
                                <td width="5px"> : </td>
                            ...
                            <tr>
                                <td width="180px"><b> Tempat Lahir </b></td>
                                <td width="5px"> : </td>
                                <td> <?php echo htmlspecialchars($row['tempat_lahir']); ?> </td>
                            </tr>
                            <tr>
 <td width="180px"><b> Tanggal Lahir </b></td>
                                <td width="5px"> : </td>
                                <td> <?php echo htmlspecialchars($row['tanggal_lahir']); ?> </td>
                            </tr>
                            <tr>
                                <td width="180px"><b> Jenis Kelamin </b></td>
                                <td width="5px"> : </td>
                                <td> <?php echo htmlspecialchars($row['jenis_kelamin']); ?> </td>
                            </tr>
                            <tr>
                                <td width="180px"><b> Agama </b></td>
                                <td width="5px"> : </td>
                                <td> <?php echo htmlspecialchars($row['agama']); ?> </td>
                            </tr>
                            <tr>
                                <td width="180px"><b> Alamat </b></td>
                                <td width="5px"> : </td>
                                <td> <?php echo htmlspecialchars($row['alamat']); ?> </td>
                            </tr>
                            <tr>
                                <td width="180px"><b> No. Telepon </b></td>
                                <td width="5px"> : </td>
