            ...
            <div id='main'>
                ...
                <table class="bordered">
                    ...
                    <?php
                        ...
                        if(isset($_POST['search-mahasiswa'])){
                            $search = mysqli_real_escape_string($koneksi, $_POST['search-mahasiswa']);
                            $query = "SELECT * FROM tbl_mahasiswa WHERE nim LIKE '%$search%' OR nama_lengkap LIKE '%$search%' OR program_studi LIKE '%$search%' OR kelas LIKE '%$search%' OR jenis_kelamin LIKE '%$search%'";
                        } else {
