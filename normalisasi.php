    ...
    <div id='main-center'>
        ...
        <div id='main'>
            ...
            <table class="bordered">
                ...
                if (isset($_POST['search-normalisasi'])) {
                    $search = mysqli_real_escape_string($koneksi, $_POST['search -normalisasi']);
                    $query = mysqli_query($koneksi, "SELECT * FROM tbl_normalisasi WHERE id_kriteria LIKE '%$search%'");
                    ...
                    $query = mysqli_query($koneksi, "SELECT * FROM tbl_normalisasi");
                    while ($row = mysqli_fetch_array($query)) {
                        echo "<tr> <td align=center>" . $row['id_normalisasi'] . "</td>
                                   <td><a href='detail-kriteria.php?kode=" . $row['id_kriteria'] . "'>" . $row['id_kriteria'] . "</a></td>
                                   <td>" . $row['n_penghasilan_ortu'] . "</td>
